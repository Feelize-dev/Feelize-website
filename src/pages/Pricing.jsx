    ...
    <div className="relative overflow-hidden">
      ...
      <div className="relative py-16 sm:py-24 lg:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Pricing Cards */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 items-stretch mb-12 sm:mb-20">
            {packages.map((pkg) => (
              <div
                key={pkg.id}
                className="transition-all duration-300 ease-in-out hover:!scale-105 hover:-translate-y-2 sm:hover:-translate-y-4 hover:z-10"
              >
