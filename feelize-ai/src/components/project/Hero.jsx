        ...
        <div className="glass-container relative max-w-6xl mx-auto">
          ...
          <div className="float-card absolute -top-20 -left-20 w-64 h-32 rounded-2xl backdrop-blur-md bg-white/5 border border-white/10 p-4 shadow-2xl rotate-[-5deg]">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs font-mono text-cyan-400">component.tsx</span>
            </div>
            <div className="space-y-1">
              <div className="h-2 bg-gradient-to-r from-cyan-400/30 to-transparent rounded" style={{ width: '80%' }} />
              <div className="h-2 bg-gradient-to-r from-purple-400/30 to-transparent rounded" style={{ width: '60%' }} />
              <div className="h-2 bg-gradient-to-r from-blue-400/30 to-transparent rounded" style={{ width: '90%' }} />
            </div>
          </div>
          ...
          <div className="float-card absolute -top-10 -right-32 w-56 h-40 rounded-2xl backdrop-blur-md bg-white/5 border border-white/10 p-4 shadow-2xl rotate-[8deg]">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs font-mono text-purple-400">ai-engine.js</span>
            </div>
            <div className="space-y-1">
              <div className="h-2 bg-gradient-to-r from-purple-400/30 to-transparent rounded" style={{ width: '70%' }} />
              <div className="h-2 bg-gradient-to-r from-cyan-400/30 to-transparent rounded" style={{ width: '85%' }} />
              <div className="h-2 bg-gradient-to-r from-purple-400/30 to-transparent rounded" style={{ width: '50%' }} />
            </div>
          </div>
          ...
          <div className="float-card absolute bottom-10 -left-32 w-72 h-36 rounded-2xl backdrop-blur-md bg-white/5 border border-white/10 p-4 shadow-2xl rotate-[-3deg]">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs font-mono text-blue-400">performance.cpp</span>
            </div>
            <div className="space-y-1">
              <div className="h-2 bg-gradient-to-r from-blue-400/30 to-transparent rounded" style={{ width: '95%' }} />
              <div className="h-2 bg-gradient-to-r from-cyan-400/30 to-transparent rounded" style={{ width: '75%' }} />
              <div className="h-2 bg-gradient-to-r from-blue-400/30 to-transparent rounded" style={{ width: '88%' }} />
            </div>
          </div>

          {/* Main Headline - Kinetic Typography */}
          <h1 className="text-center mb-8 leading-tight" style={{ perspective: '800px' }}>
          ...
          <p className="subheading text-center text-lg md:text-xl lg:text-2xl mb-12 max-w-3xl mx-auto text-gray-300 font-light tracking-wide">
            Where <span className="text-cyan-400 font-semibold">AI velocity</span> meets{' '}
            <span className="text-purple-400 font-semibold">human artistry</span>.
          ...
          <div className="flex justify-center">
            <button
              ...
              style={{
                ...
                boxShadow: '0 0 60px rgba(5, 128, 232, 0.4), 0 0 100px rgba(112, 0, 255, 0.2)',
              }}
            >
              ...
              <div 
                ...
                style={{
                  background: 'linear-gradient(135deg, #7000FF 0%, #0580E8 100%)',
                }}
              />
              ...
              <div className="absolute inset-0 blur-xl opacity-50 group-hover:opacity-100 transition-opacity duration-500"
                style={{
                  background: 'radial-gradient(circle, rgba(5, 128, 232, 0.4) 0%, transparent 70%)',
                }}
              />
            </button>
          </div>
