        ...
        <div className="container mx-auto px-16 py-24">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-20">
            {filteredProjects.map((project, index) => (
              ...
              >
                <Card className="h-full bg-black/40 backdrop-blur-xl border-2 border-purple-500/30 rounded-3xl overflow-hidden hover:border-purple-400/70 transition-all duration-500 hover:scale-[1.02] hover:-translate-y-2 shadow-2xl hover:shadow-purple-500/20">
                  ...
                  <CardContent className="relative p-0">
                    ...
                    <div className="relative overflow-hidden">
                      ...
                      <div className="absolute bottom-4 right-4 flex gap-2">
                        <div className="flex items-center gap-1 p-2 bg-purple-600/30 backdrop-blur rounded-lg border border-purple-500/30">
                          ...
                          <span className="text-white text-xs font-['Geist']">{project.timeline}</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="p-8">
                      <div className="mb-4">
                        ...
                        <p className="text-gray-400 text-sm mb-1 font-['Geist']">Client: {project.client}</p>
                      </div>
                        ...
                        <div className="space-y-2">
                          {project.results.map((result, idx) => (
                            <div key={idx} className="flex items-center gap-2 text-sm">
                              ...
                              <span className="text-gray-300 font-['Geist']">{result}</span>
                            </div>
                          ))}
                        </div>
                      </div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {project.technologies.map((tech, idx) => (
                          <Badge key={idx} className="bg-purple-600/20 text-purple-300 border border-purple-500/30 text-xs font-['Geist']">
                            {tech}
                          </Badge>
                        ))}
                      </div>
