...
import { GitBranch, Workflow, CheckCircle2, ArrowRight } from 'lucide-react';
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-20">
                    ...
                    <p className="text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed">
                        ...
                        Accelerate deployment, improve reliability, and foster collaboration.
                    </p>
                </div>
                ...
                <div className="glass-morphism rounded-3xl p-8 md:p-12 mb-16">
                    ...
                    <div className="flex flex-wrap justify-center gap-4">
                        {['Jenkins', 'GitLab CI', 'GitHub Actions', 'Docker', 'Kubernetes', 'Ansible', 'Prometheus', 'Grafana'].map((tech) => (
                            <div
                                key={tech}
                ...
                <div className="text-center">
                    ...
                    <p className="text-slate-300 mb-8 max-w-2xl mx-auto">
                        Let's build a DevOps pipeline that enhances productivity and reliability.
                    </p>
