...
import { Link as LinkIcon, Blocks, CheckCircle2, ArrowRight } from 'lucide-react';
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-20">
                    <div className="inline-flex items-center justify-center p-2 bg-cyan-500/10 rounded-2xl mb-6">
                        <Blocks className="w-12 h-12 text-cyan-400" />
                    </div>
                    <h1 className="text-5xl md:text-7xl font-bold mb-6">
                        <span className="gradient-text">Blockchain Solutions</span>
                    </h1>
                    <p className="text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed">
                        Build the future with decentralized technology and Web3 innovation.
                        From smart contracts to dApps, we bring blockchain to life.
                    </p>
                </div>
                ...
                <div className="glass-morphism rounded-3xl p-8 md:p-12 mb-16">
                    ...
                    <div className="flex flex-wrap justify-center gap-4">
                        {['Ethereum', 'Solidity', 'Web3.js', 'Hardhat', 'IPFS', 'Polygon', 'Solana', 'Rust'].map((tech) => (
                            <div
                                key={tech}
                ...
                <div className="text-center">
                    ...
                    <p className="text-slate-300 mb-8 max-w-2xl mx-auto">
                        Let's create innovative Web3 solutions that leverage blockchain technology.
                    </p>
