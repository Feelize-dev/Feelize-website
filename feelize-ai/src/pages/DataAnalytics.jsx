            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="glass-morphism rounded-3xl p-8 md:p-12 mb-16">
                    ...
                    <div className="flex flex-wrap justify-center gap-4">
                        {['Python', 'TensorFlow', 'Tableau', 'Power BI', 'Apache Spark', 'BigQuery', 'Snowflake', 'R'].map((tech) => (
                            <div
                                key={tech}
                ...
                <div className="text-center">
                    ...
                    <p className="text-slate-300 mb-8 max-w-2xl mx-auto">
                        Let's discuss your data analytics needs and create insights that drive growth.
                    </p>
