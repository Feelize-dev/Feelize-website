...
import { ShoppingCart, Store, CheckCircle2, ArrowRight } from 'lucide-react';
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-20">
                    ...
                    <p className="text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed">
                        ...
                        From startups to enterprises, we create e-commerce experiences that sell.
                    </p>
                </div>
                ...
                <div className="glass-morphism rounded-3xl p-8 md:p-12 mb-16">
                    ...
                    <div className="flex flex-wrap justify-center gap-4">
                        {['Shopify', 'WooCommerce', 'Magento', 'BigCommerce', 'Stripe', 'PayPal', 'Square', 'Custom'].map((tech) => (
                            <div
                                key={tech}
                ...
                <div className="text-center">
                    ...
                    <p className="text-slate-300 mb-8 max-w-2xl mx-auto">
                        Let's create an e-commerce platform that scales with your business.
                    </p>
