...
const createEntity = (entityName) => ({
  async create(data) {
    try {
      const response = await axios.post(`${API_BASE_URL}/api/${entityName}`, data);
  ...
  async get(id) {
    try {
      const response = await axios.get(`${API_BASE_URL}/api/${entityName}/${id}`);
      return response.data;
    } catch (error) {
  ...
  async filter(params) {
    try {
      const response = await axios.get(`${API_BASE_URL}/api/${entityName}`, { params });
      return response.data;
    } catch (error) {
  ...
  async update(id, data) {
    try {
      const response = await axios.put(`${API_BASE_URL}/api/${entityName}/${id}`, data);
      return response.data;
    } catch (error) {
  ...
  async delete(id) {
    try {
      const response = await axios.delete(`${API_BASE_URL}/api/${entityName}/${id}`);
      return response.data;
    } catch (error) {
